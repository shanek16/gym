...
register(
    id="Rand_cycle_v1_rel_box",
    entry_point="gym.envs.custom_env.rand_cycle_v1_rel_box:Rand_cycle_v1_rel_box",
...
register(
    id="MUMT_v3",
    entry_point="gym.envs.custom_env.mumt_v3:MUMT_v3",
    max_episode_steps=6000,
)

register(
    id="MUMT_v5",
    entry_point="gym.envs.custom_env.mumt_v5:MUMT_v5",
    max_episode_steps=6000,
)

register(
    id="MUMT_v6",
    entry_point="gym.envs.custom_env.mumt_v5:MUMT_v6",
    max_episode_steps=6000,
)
...
register(
    id="Noise_DKC_Unicycle",
    entry_point="gym.envs.custom_env.noise_dkc_unicycle:Noise_DKC_Unicycle",
    max_episode_steps=4000, #80/75*3600*50*1.5,
)

register(
    id="Noise_TOC_Unicycle",
